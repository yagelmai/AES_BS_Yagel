gcc -no-pie test_KM.c aux_tests.c aux_code.o students_code.S -o test_KM.out
...
gcc -no-pie test_BS.c aux_tests.c aux_code.o students_code.S -o test_BS.out
if [ -f "test_KM.out" ]; then
...
gcc -no-pie test_SR.c aux_tests.c aux_code.o students_code.S -o test_SR.out
if [ -f "test_KM.out" ]; then
...
gcc -no-pie test_cipher.c aux_tests.c aux_code.o students_code.S -o test_cipher.out
if [ -f "test_KM.out" ]; then
